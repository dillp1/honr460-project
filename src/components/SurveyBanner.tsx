...
function SurveyBanner({
  ...
  return (
    <section className="fixed left-0 right-0 top-20 z-40 border-b border-[#d8b15a]/30 bg-[#fff7e3] text-[#161d2e] shadow-[0_10px_24px_rgba(22,29,46,0.08)]">
      <div className="mx-auto grid w-full max-w-7xl gap-3 px-4 py-3 sm:px-6 md:grid-cols-[1fr_auto_auto] md:items-center md:px-10 lg:px-16">
        ...
        <button
          type="button"
          onClick={onClose}
          className="inline-flex size-9 items-center justify-center self-start rounded-full text-[#161d2e]/65 transition-colors hover:bg-[#161d2e]/8 hover:text-[#161d2e] md:self-center"
