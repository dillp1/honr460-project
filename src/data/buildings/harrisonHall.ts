  ...
  entrances: [
    {
      ...
      entranceVisibility: "low",
      requiresDetour: true,
      notes:
        "Accessible approach with a downward ramp and ADA button. The entrance is tucked away between three walls of the building.",
    },
    {
      id: "harrison-north-east",
      name: "North-East Front Entrance",
